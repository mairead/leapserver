...
(function() {
  ...
  FrameSplicer = (function() {
    function FrameSplicer(controller, userId, options) {
      //console.log("frame splicer function");
      var frameSplicer;
      this.userId = userId;
  ...
  Leap.plugin('networking', function(scope) {
    ...
    scope.peer.on('open', function(id) {
      ...
      //console.log("splicer gets created here");
    ...
    return {
      beforeFrameCreated: function(frameData) {
        ...
        if (!frameSplicer) {//just adding in a bit of error handling in case splicer not ready yet
          return;
        }
